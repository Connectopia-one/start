                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-3">
                          <span className="text-xs text-ink-dim">
                            {vindNiveau(h.niveau)?.emoji}{" "}
                            {vindNiveau(h.niveau)?.naam}
                          </span>
                      ...
                      <details className="mt-2">
                        ...
                        >
                          ...
                          <p className="w-full text-xs text-ink-dim">
                            Het webadres blijft hetzelfde. Let op: een
                            bulk-import zoekt een hoofdstuk op zijn titel, dus
              ...
              <details className="mt-4 rounded-lg border border-border">
                ...
                <div className="border-t border-border p-3">
                  <p className="text-sm text-ink-dim">
                    Plak hier vragen voor meerdere hoofdstukken in één keer —
                    handig na het voorbereiden met DeepSeek/Gemini op basis van
                    een vakfiche. Een hoofdstuk met een titel die hierboven al
                    bestaat krijgt de vragen erbij; een nieuwe titel wordt
                    automatisch als hoofdstuk aangemaakt. Vraag je AI-tool om
                    exact dit formaat te gebruiken:
                  </p>
