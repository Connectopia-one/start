...
DEEL1 = [
    dict(
        type="meerkeuze",
        vraag="Hoe noem je een hoek die precies past in de hoek van een blad papier?",
    ...
    dict(
        type="invultekst",
        vraag="Hoeveel is de som van de hoeken van een vierhoek, in graden?",
        antwoord="360",
        uitleg="360°. Je kan elke vierhoek met één diagonaal in twee driehoeken verdelen: 2 × 180° = 360°.",
    ),
    dict(
        type="meerkeuze",
        vraag="Hoe noem je een driehoek met drie gelijke zijden?",
    ...
    dict(
        type="invultekst",
        vraag="Hoeveel graden is elke hoek van een gelijkzijdige driehoek?",
        antwoord="60",
        uitleg="De drie hoeken zijn even groot en samen 180°, dus elk 180 : 3 = 60°.",
    ),
    dict(
        type="meerkeuze",
        vraag="In een gelijkbenige driehoek heet de hoek tussen de twee gelijke zijden de …",
    ...
    dict(
        type="meerkeuze",
        vraag="Hoe noem je de langste zijde van een rechthoekige driehoek?",
    ...
    dict(
        type="meerkeuze",
        vraag="Een vierhoek waarvan beide paren overstaande zijden evenwijdig zijn, heet een …",
    ...
    dict(
        type="waarofniet",
        vraag="Een ruit heeft vier even lange zijden.",
        antwoord=True,
    ...
    dict(
        type="meerkeuze",
        vraag="Hoe noem je de lijn van het middelpunt van een cirkel naar de rand?",
    ...
    dict(
        type="meerkeuze",
        vraag="Een cirkel heeft een straal van 6 cm. Hoe lang is de diameter?",
    ...
    dict(
        type="meerkeuze",
        vraag="Twee rechten staan loodrecht op elkaar. Welke hoek maken ze?",
        opties=["90°", "45°", "180°"],
        antwoord=0,
    ...
    dict(
        type="invultekst",
        vraag="Hoeveel symmetrieassen heeft een vierkant?",
        antwoord="4",
        uitleg="Vier: de twee middelloodlijnen van de zijden en de twee diagonalen.",
    ),
    dict(
        type="meerkeuze",
        vraag="Hoeveel symmetrieassen heeft een gewone rechthoek die geen vierkant is?",
        opties=["2", "4", "1"],
        antwoord=0,
    ...
    dict(
        type="meerkeuze",
        vraag="Een figuur schuift een eindje opzij, zonder te draaien of te spiegelen. Welke transformatie is dat?",
    ...
    dict(
        type="waarofniet",
        vraag="Na een spiegeling is de figuur even groot als daarvoor.",
        antwoord=True,
...
DEEL2 = [
    dict(
        type="meerkeuze",
        vraag="Twee rechten snijden elkaar. Eén hoek is 70°. Hoe groot is de hoek er recht tegenover?",
        opties=["70°", "110°", "20°"],
        antwoord=0,
    ...
    dict(
        type="meerkeuze",
        vraag="Een hoek is 70°. Hoe groot is zijn nevenhoek?",
        opties=["110°", "20°", "70°"],
        antwoord=0,
    ...
    dict(
        type="meerkeuze",
        vraag="Twee evenwijdige rechten worden gesneden door een derde rechte. Wat weet je over de overeenkomstige hoeken?",
    ...
    dict(
        type="meerkeuze",
        vraag="Twee evenwijdige rechten, een snijlijn, en een binnenhoek van 65°. Hoe groot is de binnenhoek aan dezelfde kant van de snijlijn?",
        opties=["115°", "65°", "25°"],
        antwoord=0,
    ...
    dict(
        type="meerkeuze",
        vraag="In een gelijkbenige driehoek is de tophoek 40°. Hoe groot is elke basishoek?",
        opties=["70°", "40°", "140°"],
        antwoord=0,
    ...
    dict(
        type="meerkeuze",
        vraag="In een gelijkbenige driehoek is een basishoek 50°. Hoe groot is de tophoek?",
        opties=["80°", "50°", "130°"],
        antwoord=0,
    ...
    dict(
        type="meerkeuze",
        vraag="Drie hoeken van een vierhoek zijn 90°, 100° en 85°. Hoe groot is de vierde?",
        opties=["85°", "95°", "75°"],
        antwoord=0,
    ...
    dict(
        type="meerkeuze",
        vraag="Hoe noem je de lijn uit een hoekpunt die de hoek in twee gelijke stukken verdeelt?",
    ...
    dict(
        type="meerkeuze",
        vraag="Welke merkwaardige lijn staat loodrecht op een zijde en gaat door het midden van die zijde?",
    ...
    dict(
        type="meerkeuze",
        vraag="Een figuur draait een kwartslag rond een punt. Welke transformatie is dat?",
    ...
    dict(
        type="meerkeuze",
        vraag="Welke eigenschap blijft NIET noodzakelijk behouden bij een spiegeling om een rechte?",
        opties=[
    ...
    dict(
        type="invultekst",
        vraag="Hoeveel symmetrieassen heeft een gelijkzijdige driehoek?",
        antwoord="3",
    ...
    dict(
        type="meerkeuze",
        vraag="In een parallellogram is één hoek 110°. Hoe groot is de hoek ernaast?",
        opties=["70°", "110°", "90°"],
        antwoord=0,
    ...
    dict(
        type="waarofniet",
        vraag="De diagonalen van een ruit staan loodrecht op elkaar.",
        antwoord=True,
    ...
    dict(
        type="meerkeuze",
        vraag="Een driehoek heeft hoeken van 90° en 45°. Wat weet je nog meer?",
        opties=[
