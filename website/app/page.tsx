  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto grid w-full max-w-5xl gap-9 px-5 py-14 md:grid-cols-[1.2fr_0.85fr] md:items-center">
          <div>
            ...
            <p className="mt-4 max-w-[48ch] text-[17px] text-ink-dim">{home.hero.tekst}</p>
            <div className="mt-7 flex flex-wrap gap-3">
              <Knop href={home.hero.knopPrimair.link}>{home.hero.knopPrimair.tekst}</Knop>
          ...
          <aside className="rounded-[20px] border border-border bg-surface p-6 shadow-[0_2px_10px_rgba(47,74,34,0.07)]">
            ...
            <h2 className="mt-1.5 text-lg text-green">{home.kiesJeRichting.titel}</h2>
      ...
      {home.aankondiging ? (
        <section className="bg-green text-cream">
          <div className="mx-auto flex w-full max-w-5xl flex-wrap items-center justify-center gap-x-5 gap-y-2 px-5 py-4 text-center text-[15px] font-bold">
            ...
            <Link href={home.aankondiging.link.href} className="font-extrabold underline-offset-4 hover:underline">
      ...
      <section className="mx-auto w-full max-w-5xl px-5 py-14">
        ...
        <h2 className="mt-1.5 text-3xl text-green">{home.blokken.watwedoen.titel}</h2>
        <p className="mt-2 max-w-[62ch] text-ink-dim">{home.blokken.watwedoen.tekst}</p>
          ...
          >
            <div className="grid gap-6 md:grid-cols-[1.1fr_0.9fr] md:items-center">
              <div>
                ...
                <h3 className="mt-3 text-2xl text-green">{wegwijzerTekst.titel}</h3>
      ...
      <section className="mx-auto w-full max-w-5xl px-5 pb-14">
        ...
        <h2 className="mt-1.5 text-3xl text-green">{home.blokken.platform.titel}</h2>
        <p className="mt-2 max-w-[62ch] text-ink-dim">{home.blokken.platform.tekst}</p>
      ...
      <section className="mx-auto w-full max-w-5xl px-5 pb-14">
        ...
        <h2 className="mt-1.5 text-3xl text-green">{home.blokken.kennis.titel}</h2>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <p className="text-[15px] text-ink-dim">{home.partnerBlok.omschrijving}</p>
...
function SponsorVak({ sponsor }: { sponsor: { naam: string; logo?: string; link?: string } }) {
  ...
  if (sponsor.link) {
    return (
      <a href={sponsor.link} target="_blank" rel="noopener noreferrer" className={`${vak} transition hover:-translate-y-0.5`}>
        {inhoud}
      </a>
    );
  }
