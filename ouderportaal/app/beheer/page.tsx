        ...
        <div className="mt-8 grid gap-8 sm:grid-cols-2">
              ...
              {(klasjes ?? []).map((k) => (
                ...
                >
                  ...
                  <div className="mt-1 flex gap-3 text-sm">
                    <Link
                      href={`/beheer/klasjes/${k.slug}/materiaal`}
                      className="text-forest-dark hover:underline"
                    >
                      Lesmateriaal
                    </Link>
                    <Link
                      href={`/beheer/klasjes/${k.slug}/fotos`}
                      className="text-forest-dark hover:underline"
                    >
                      Foto&apos;s
                    </Link>
          ...
          <section>
            ...
            <p className="mt-3 text-sm text-ink-dim">
              Accounts van ouders aanmaken en per klasje instellen of ze
              lesmateriaal en/of foto&apos;s mogen zien.
            </p>
            <Link
            ...
            <p className="mt-3 text-sm text-ink-dim">
              Accounts voor werknemers: zij kunnen foto&apos;s toevoegen en
              fiches bekijken, maar geen klasjes of lesmateriaal beheren.
            </p>
            <Link
              href="/beheer/team"
              className="mt-4 inline-block rounded-md bg-forest px-3 py-2 text-sm font-medium text-white hover:bg-forest-dark"
            ...
            <h2 className="mt-8 font-display text-lg font-semibold text-ink">
              ...
              {(nieuweBriefjes ?? 0) > 0 && (
                <span className="ml-2 rounded-full bg-forest px-2 py-0.5 align-middle text-xs font-semibold text-white">
                  {nieuweBriefjes} nieuw
                </span>
              )}
            </h2>
            <p className="mt-3 text-sm text-ink-dim">
              De briefjes die bezoekers op de website ophangen, en de meldingen
              die erover binnenkomen.
            </p>
            <Link
              href="/beheer/prikbord"
              className="mt-4 inline-block rounded-md bg-forest px-3 py-2 text-sm font-medium text-white hover:bg-forest-dark"
            >
